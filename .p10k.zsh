# Generated by Powerlevel10k configuration wizard on 2020-10-19 at 11:54 WIB.
...
# unicode, 24h time, angled separators, sharp heads, flat tails, 1 line, compact,
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    ##benv                   # ruby version from rbenv (https://github.com/rbenv/rbenv)
  ...
  # be either absolute (e.g., '79') or a percentage of terminal width (e.g, '50%'). If empty,
